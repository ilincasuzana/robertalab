...
import de.fhg.iais.roberta.syntax.codegen.turtlebot.PythonVisitor;
import de.fhg.iais.roberta.transformer.BlocklyProgramAndConfigTransformer;
import de.fhg.iais.roberta.transformer.turtlebot.Jaxb2Ev3ConfigurationTransformer;
...
public class CompilerWorkflow extends AbstractCompilerWorkflow {
    ...
    public String generateSourceCode(String token, String programName, BlocklyProgramAndConfigTransformer data, ILanguage language) {
        ...
        return PythonVisitor.generate((TurtlebotConfiguration) data.getBrickConfiguration(), data.getProgramTransformer().getTree(), true, language);
    }
